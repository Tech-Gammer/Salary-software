...
class resticatedEmployee extends StatefulWidget {
  const resticatedEmployee({super.key});

  @override
  State<resticatedEmployee> createState() => _resticatedEmployeeState();
}

class _resticatedEmployeeState extends State<resticatedEmployee> {

  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<EmployeeProvider>(context, listen: false).fetchresticatedEmployees();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    double resticationDateColumnWidth = maxWidthForColumn('Restication Date', employeeProvider.employees);
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: DataTable(
                        ...
                        columns: [
                          ...
                          DataColumn(label: SizedBox(width: resticationDateColumnWidth, child: const Text('Restication Date', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)))),
                        ...
                        rows: employeeProvider.employees.asMap().entries.map((entry) {
                          ...
                          return DataRow(
                            cells: [
                              ...
                              DataCell(Text(employee.resticationDate ?? "N/A")), // Show "N/A" if no restication date
